    ...
    AdultManager: [function(t, e, i) {
        ...
        cc.Class({
            ...
            initPartNew: function(t, e) {
                ...
                s.getChildByName("Label").getComponent(cc.Label).string = "加载中",
                    cc.loader.loadResDir(c, cc.SpriteFrame, function(a, c) {
                        if (a)
                            return s.getChildByName("Label").getComponent(cc.Label).string = "出现错误，请重试",
        ...
        cc.Class({
            ...
            initSprites: function(t) {
                ...
                if (this.is_preloaded) {
                    ...
                    c.getChildByName("Label").getComponent(cc.Label).string = "加载中",
                        cc.loader.loadResDir(i, cc.SpriteFrame, function(i, a) {
                            if (i)
                                return c.getChildByName("Label").getComponent(cc.Label).string = "出现错误，请重试",
